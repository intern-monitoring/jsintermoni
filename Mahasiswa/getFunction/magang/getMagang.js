...
<div class="flex flex-col cursor-pointer justify-start rounded-xl p-4 md:p-6 bg-white border border-gray-200 shadow-md hover:shadow-lg hover:-translate-y-2 transition-all duration-500 ease-in-out">
  <div class="flex items-center gap-x-4">
    ...
    />
    <div class="grow">
      <h3 class="font-medium text-gray-800">#POSISI#</h3>
      <p class="text-xs uppercase text-gray-500">#MITRA#</p>
    </div>
  </div>
  <div class="flex items-center gap-x-4">
    <div class="grow">
